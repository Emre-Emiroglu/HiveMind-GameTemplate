...
namespace HiveMindGameTemplate.Runtime.Views.UI
{
    ...
    public class WaveWinPanelView : View, IUIPanel
    {
        #region Events
        public UnityAction NextWaveButtonClicked;
        #endregion

        #region Fields
        [Header("Wave Win Panel View Fields")]
        ...
        public void OnNextWaveButtonClicked() => NextWaveButtonClicked?.Invoke();
        #endregion
    }
}
